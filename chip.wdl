...
#CAPER docker quay.io/encode-dcc/chip-seq-pipeline:dev-v1.3.2
#CAPER singularity docker://quay.io/encode-dcc/chip-seq-pipeline:dev-v1.3.2
#CROO out_def https://storage.googleapis.com/encode-pipeline-output-definition/chip.croo.json

workflow chip {
	String pipeline_ver = 'dev-v1.3.2'
